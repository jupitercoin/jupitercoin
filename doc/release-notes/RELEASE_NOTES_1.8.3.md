# Jupitercoin Core 1.8.3

Jupitercoin Core 1.8.3 is a security release. It fixes issues in regards to an upcoming announcement of possible DoS vulnerabilities.
...
into this Jupitercoin Core release:
