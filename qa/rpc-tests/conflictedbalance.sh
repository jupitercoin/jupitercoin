...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars JUPITERCOIND and JUPITERCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

BITCOIND=${JUPITERCOIND:-${1}/jupitercoind}
CLI=${JUPITERCOINCLI:-${1}/jupitercoin-cli}
