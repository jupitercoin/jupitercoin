...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Jupitercoin Core jupitercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jupitercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jupitercoin transaction") + "\n" +
              "  jupitercoin-tx [options] -create [commands]   " + _("Create hex-encoded jupitercoin transaction") + "\n" +
              "\n";
