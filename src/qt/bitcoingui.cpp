...
// Copyright (c) 2014-2015 The Jupitercoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Jupitercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Jupitercoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jupitercoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Jupitercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jupitercoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Jupitercoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jupitercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jupitercoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Jupitercoin Core help message to get a list with possible Jupitercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Jupitercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jupitercoin network", "", count));
}
...
{
    QString strTitle = tr("Jupitercoin"); // default title
