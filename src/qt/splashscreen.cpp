    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Jupitercoin Core");
    ...
    QString copyrightTextDoge  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Jupitercoin Core developers"));
