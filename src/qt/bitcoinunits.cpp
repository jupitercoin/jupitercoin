...
QString BitcoinUnits::name(int unit)
{
    ...
    case kBTC: return QString("kJPC");
    case BTC: return QString("JPC");
    case mBTC: return QString("mJPC");
    case uBTC: return QChar(0x03BC) + QString("JPC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Jupitercoins (1,000,000)");
    case kBTC: return tr("Kilo-Jupitercoins (1,000)");
    case BTC: return tr("Jupitercoins");
    case mBTC: return tr("Milli-Jupitercoins (1 / 1,000)");
    case uBTC: return tr("Micro-Jupitercoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
