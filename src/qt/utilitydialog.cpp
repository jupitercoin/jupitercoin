    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Jupitercoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Jupitercoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Jupitercoin Core is shutting down...") + "<br /><br />" +
