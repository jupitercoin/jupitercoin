...
uint256 hashGenesisBlock("0x5e7efddc7a3513b4e7f248d813ea33c0cff6f16ac529d3939a4fef5fbc95de29");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jupitercoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JupiterCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "New GET RICH QUICK ALTCOIN! (GRQALT) - Today 5.18.2013 by smeagol";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1368902509;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1095867;

        if (fTestNet)
        {
            block.nTime    = 1368902499;
            block.nNonce   = 540482;
        }
