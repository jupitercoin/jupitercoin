        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Jupitercoin: Disable free transactions
...
{
    // Jupitercoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Jupitercoin: Add an increased fee for each dust output
        nFeeNeeded += GetJupitercoinDustFee(tx.vout, minTxFee);
    }
